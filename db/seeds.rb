...
@item_11 = Item.create!(name: "Item 1", description: "Item 1 desc", status: 1, merchant_id: @merchant_2.id, unit_price: 100)
@item_12 = Item.create!(name: "Item 2", description: "Item 2 desc", status: 1, merchant_id: @merchant_2.id, unit_price: 200)
@item_13 = Item.create!(name: "Item 3", description: "Item 3 desc", status: 1, merchant_id: @merchant_2.id, unit_price: 300)
@item_14 = Item.create!(name: "Item 4", description: "Item 4 desc", status: 1, merchant_id: @merchant_2.id, unit_price: 400)
@item_15 = Item.create!(name: "Item 5", description: "Item 5 desc", status: 1, merchant_id: @merchant_2.id, unit_price: 500)
@item_16 = Item.create!(name: "Item 6", description: "Item 6 desc", status: 1, merchant_id: @merchant_2.id, unit_price: 600)
@item_17 = Item.create!(name: "Item 7", description: "Item 7 desc", status: 1, merchant_id: @merchant_2.id, unit_price: 700)
@item_18 = Item.create!(name: "Item 8", description: "Item 8 desc", status: 1, merchant_id: @merchant_2.id, unit_price: 800)
@item_19 = Item.create!(name: "Item 9", description: "Item 9 desc", status: 1, merchant_id: @merchant_2.id, unit_price: 900)
@item_20 = Item.create!(name: "Item 10", description: "Item 10 desc", status: 1, merchant_id: @merchant_2.id, unit_price: 1000)
