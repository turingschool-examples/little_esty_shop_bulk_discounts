RSpec.describe 'merchant discounts' do
  ...
  it "can show all of the merchant's discounts" do
    expect(page).to have_content(@discount1.id)
    expect(page).not_to have_content(@discount2.id)
  ...
  it "has each discount listed that also has a link to it's show page" do
