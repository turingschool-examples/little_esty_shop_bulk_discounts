...
RSpec.describe 'invoices show' do
  ...
  it "links to discounts applied" do
    merchant1 = Merchant.create!(name: 'Hair Care')
    merchant2 = Merchant.create!(name: 'Jewelry')
    ...
    bulk_discount_1 = merchant1.bulk_discounts.create(percentage: 9, threshold: 5)
    bulk_discount_2 = merchant1.bulk_discounts.create(percentage: 10, threshold: 6)
  ...
  it "has links to discount applied per invoice item" do
    merchant1 = Merchant.create!(name: 'Hair Care')
    customer_1 = Customer.create!(first_name: 'Joey', last_name: 'Smith')
    ...
    expect(page).to have_content("Discount Id: #{bulk_discount_1.id}")
    expect(page).to have_link("#{bulk_discount_1.id}")
  end
