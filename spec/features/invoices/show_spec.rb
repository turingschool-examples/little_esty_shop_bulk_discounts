...
RSpec.describe 'invoices show' do
  before :each do
    ...
    @bulk_discount_1 = BulkDiscount.create(discount: 5, quantity: 1, merchant: @merchant1)
    @bulk_discount_2 = BulkDiscount.create!(discount: 20, quantity: 5, merchant: @merchant1)
