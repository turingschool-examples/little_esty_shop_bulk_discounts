...
RSpec.describe 'Bulk Discount Edit', type: :feature do
  before(:each) do
    ...
    @bulk_discount_1 = BulkDiscount.create!(percentage_discount: 10, quantity_threshold: 15, merchant_id: @merchant_1.id)
  ...
  describe 'User Story 4 (Edit Action)' do
    ...
    it 'when filled with partial data, I am redirected back to the bulk discount show page, where I see the updated data' do
    ...
    it 'when filled out with all data, I am redirected back to the bulk discount show page, where I see the updated data' do
      fill_in :percentage_discount, with: 30
