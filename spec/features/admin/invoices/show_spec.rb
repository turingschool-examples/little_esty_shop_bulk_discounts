...
describe 'Admin Invoices Index Page' do
  before :each do
    ...
    @discount1 = BulkDiscount.create!(percentage: 10, quantity_threshold: 5, merchant_id: @m1.id)
