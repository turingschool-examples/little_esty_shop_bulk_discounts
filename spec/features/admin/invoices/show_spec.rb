...
describe 'Admin Invoices Index Page' do
  before :each do
    ...
    @bulk_discount_1 = BulkDiscount.create!(name: '20% off', percentage_discount: 20, quantity_threshold: 10, merchant_id: @m1.id)
  ...
  it 'should display the total revenue the invoice will generate' do
    expect(page).to have_content("Total Revenue before bulk discounts: #{@i1.total_revenue}")
  ...
  it 'shows the total revenue includes bulk discounts in the calculation' do
    expect(page).to have_content("Total Revenue with bulk discounts: #{@i1.total_revenue_with_discounts}")
  end
end
