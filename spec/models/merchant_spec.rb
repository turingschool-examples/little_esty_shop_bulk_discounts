...
describe Merchant do
  ...
  describe 'class methods' do
    before :each do
      ...
      @ii_3 = InvoiceItem.create!(invoice_id: @invoice_3.id, item_id: @item_2.id, quantity: 2, unit_price: 8,
                                  status: 2, created_at: '2012-03-28 14:54:09')
      @ii_4 = InvoiceItem.create!(invoice_id: @invoice_4.id, item_id: @item_3.id, quantity: 3, unit_price: 5,
                                  status: 1, created_at: '2012-03-30 14:54:09')
      @ii_6 = InvoiceItem.create!(invoice_id: @invoice_5.id, item_id: @item_4.id, quantity: 1, unit_price: 1,
                                  status: 1, created_at: '2012-04-01 14:54:09')
      @ii_7 = InvoiceItem.create!(invoice_id: @invoice_6.id, item_id: @item_7.id, quantity: 1, unit_price: 3,
                                  status: 1, created_at: '2012-04-02 14:54:09')
      @ii_8 = InvoiceItem.create!(invoice_id: @invoice_7.id, item_id: @item_8.id, quantity: 1, unit_price: 5,
                                  status: 1, created_at: '2012-04-03 14:54:09')
      @ii_9 = InvoiceItem.create!(invoice_id: @invoice_7.id, item_id: @item_4.id, quantity: 1, unit_price: 1,
                                  status: 1, created_at: '2012-04-04 14:54:09')
      @ii_10 = InvoiceItem.create!(invoice_id: @invoice_8.id, item_id: @item_4.id, quantity: 1, unit_price: 1,
                                   status: 1, created_at: '2012-04-04 14:54:09')
      @ii_11 = InvoiceItem.create!(invoice_id: @invoice_9.id, item_id: @item_9.id, quantity: 1, unit_price: 1,
                                   status: 1, created_at: '2012-04-04 14:54:09')
      @ii_12 = InvoiceItem.create!(invoice_id: @invoice_9.id, item_id: @item_10.id, quantity: 1, unit_price: 1,
                                   status: 1, created_at: '2012-04-04 14:54:09')
      @ii_13 = InvoiceItem.create!(invoice_id: @invoice_9.id, item_id: @item_11.id, quantity: 1, unit_price: 1,
                                   status: 1, created_at: '2012-04-04 14:54:09')
      @ii_14 = InvoiceItem.create!(invoice_id: @invoice_9.id, item_id: @item_12.id, quantity: 1, unit_price: 1,
                                   status: 1, created_at: '2012-04-04 14:54:09')
      ...
      @transaction7 = Transaction.create!(credit_card_number: 203_942, result: 1, invoice_id: @invoice_8.id)
      @transaction8 = Transaction.create!(credit_card_number: 203_942, result: 1, invoice_id: @invoice_9.id)
    end
    ...
    it 'top_merchants' do
      ...
      expect(actual).to eq(['Hair Care', 'Office Space', 'The Office', 'Office Improvement', 'Pens & Stuff'])
    end
  end
  ...
  describe 'instance methods' do
    ...
    it 'shows a list of favorite customers' do
      ...
      expect(actual).to eq([@customer_1.first_name, @customer_2.first_name, @customer_3.first_name,
                            @customer_4.first_name, @customer_6.first_name])
    end
