...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    it ".discounted_revenue" do
      ...
      ii_4 = InvoiceItem.create!(invoice_id: invoice_2.id, item_id: item_3.id, quantity: 1, unit_price: 2, status: 1)
      ...
      expect(invoice_2.discounted_revenue).to eq('No Discount Applied')
    end
  end
