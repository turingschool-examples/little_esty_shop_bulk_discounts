...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    describe 'total_discounted_revenue' do
      it 'can calulate the total discounted revenue' do
        @merchant1 = Merchant.create!(name: 'Hair Care')
        @item_1 = Item.create!(name: "Shampoo", description: "This washes your hair", unit_price: 10, merchant_id: @merchant1.id, status: 1)
        @item_8 = Item.create!(name: "Butterfly Clip", description: "This holds up your hair but in a clip", unit_price: 5, merchant_id: @merchant1.id)
        @customer_1 = Customer.create!(first_name: 'Joey', last_name: 'Smith')
        ...
        # @discount_2 = BulkDiscount.create!(merchant_id: @merchant1.id, quantity: 5, percentage: 75, name: 'Winner'  )

        expect(@invoice_1.total_discounted_revenue(@merchant1.id)).to eq 45
      end
      ...
      it 'doesnt apply discounts when not needed' do
        ...
        expect(@invoice_1.total_discounted_revenue(@merchant1.id)).to eq 0
      end
    end
  end
end
