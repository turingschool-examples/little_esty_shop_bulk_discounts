...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe "instance methods" do
    it "applicable_discount" do
      ...
      @ii_2 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_8.id, quantity: 12, unit_price: 10, status: 1)
      ...
      expect(@ii_2.applicable_discount).to eq(@bulk_discount_2)
    end
  end
end
